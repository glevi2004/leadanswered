...
export const metadata = { title: "Customers — Lead Answered" };
...
export default async function CrmPage() {
  ...
  return (
    <div className="flex flex-col gap-5">
      {/* no header actions — that corner belongs to the Sarah button (Levi 2026-07-13);
          Import lives in the table toolbar inside CrmIndex */}
      <PageHeader title="Customers" description="Every lead and customer, organized and worked automatically." />
      ...
      {contacts.length === 0 ? (
        <div className="flex flex-col items-center gap-3">
          <EmptyState
            ...
            askSarah
          />
          <Button variant="outline" size="sm" className="gap-1.5" nativeButton={false} render={<Link href="/customers/import" />}>
