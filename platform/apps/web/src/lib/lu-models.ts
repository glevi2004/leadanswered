...
export const LU_MODELS: readonly LuModelOption[] = [
  { id: "claude-sonnet-5", label: "Sonnet", hint: "Balanced — the recommended default", recommended: true },
  { id: "claude-opus-4-8", label: "Opus", hint: "Deepest planning (slower, pricier)" },
  { id: "claude-haiku-4-5", label: "Haiku", hint: "Fastest, cheapest" },
  { id: "gpt-5", label: "GPT-5", hint: "OpenAI — strong tool use" },
  { id: "gemini-2.5-pro", label: "Gemini 2.5 Pro", hint: "Long context, multimodal" },
];
